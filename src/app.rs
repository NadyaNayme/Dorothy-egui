                    ...
                    egui::ScrollArea::vertical()
                        ...
                        .show(ui, |ui| {
                            if self.config.app_settings.current_ui_tab == UiTab::Akasha
                                || self.config.app_settings.show_all_drops
                            {
                                place_total_header(Raid::Akasha, Item::NoDrop, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::NoDrop, ChestType::None, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::HollowKey, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::SilverCentrum, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::GoldBrick, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::CoronationRing, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::LineageRing, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::IntricacyRing, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::ChampionMerit, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::SupremeMerit, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::LegendaryMerit, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::WeaponPlusMark1, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::WeaponPlusMark2, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::Akasha, Item::WeaponPlusMark3, ChestType::Blue, &local_settings_copy, ui);
                            }
                            if self.config.app_settings.current_ui_tab == UiTab::PBHL
                                || self.config.app_settings.show_all_drops
                            {
                                place_total_header(Raid::PBHL, Item::NoDrop, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::PBHL, Item::NoDrop, ChestType::None, &local_settings_copy, ui);
                                place_percentage_label(Raid::PBHL, Item::GoldBrick, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::PBHL, Item::CoronationRing, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::PBHL, Item::LineageRing, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::PBHL, Item::IntricacyRing, ChestType::Blue, &local_settings_copy, ui);
                            }
                            if self.config.app_settings.current_ui_tab == UiTab::GOHL
                                || self.config.app_settings.show_all_drops
                            {
                                place_total_header(Raid::GOHL, Item::NoDrop, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::NoDrop, ChestType::None, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::VerdantAzurite, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::SilverCentrum, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::GoldBrick, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::CoronationRing, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::LineageRing, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::IntricacyRing, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::ChampionMerit, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::SupremeMerit, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::GOHL, Item::LegendaryMerit, ChestType::Blue, &local_settings_copy, ui);
                            }

                            if self.config.app_settings.current_ui_tab == UiTab::Hosts
                                || self.config.app_settings.show_all_drops
                            {
                                place_total_header(Raid::UBHL, Item::NoDrop, ChestType::Blue, &local_settings_copy, ui);
                                place_percentage_label(Raid::UBHL, Item::GoldBrick, ChestType::Host, &local_settings_copy, ui);
                                place_percentage_label(Raid::UBHL, Item::GoldBrick, ChestType::Flip, &local_settings_copy, ui);
                                place_percentage_label(Raid::PBHL, Item::GoldBrick, ChestType::Host, &local_settings_copy, ui);
                                place_percentage_label(Raid::Xeno, Item::GoldBrick, ChestType::Flip, &local_settings_copy, ui);
                            }
                        });
                });
        }
